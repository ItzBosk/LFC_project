...
Se utilizzi **Windows** puoi eseguire il file ["*SPL Installer.msi*"](https://github.com/ItzBosk/LFC_project/blob/main/Workspace_Shakespeare/SPL%20Installer.msi) dal nostro progetto su github, seguire le semplici istruzioni visualizzate all'interno del software di installazione e quindi eseguire la nuova installazione SPL Software dal collegamento sul desktop.
