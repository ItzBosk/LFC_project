...
public class ShakespeareParser extends Parser {
		...
		try {
			...
			switch (alt24) {
				...
				case 2 :
					...
					while (true) {
						...
						case 1 :
							// C:\\Users\\kevbosk\\Documents\\Università\\github_repo\\LFC_project\\Workspace_Shakespeare\\src\\compilerPackage\\Shakespeare.g:145:116: adjectiveSecond
							{
							pushFollow(FOLLOW_adjectiveSecond_in_stageEvent768);
							adjectiveSecond();
							state._fsp--;
				...
				case 3 :
					...
					match(input,THYSELF,FOLLOW_THYSELF_in_stageEvent831); 
					match(input,AND,FOLLOW_AND_in_stageEvent833); 
					match(input,A,FOLLOW_A_in_stageEvent835); 
					...
					while (true) {
						...
						case 1 :
							// C:\\Users\\kevbosk\\Documents\\Università\\github_repo\\LFC_project\\Workspace_Shakespeare\\src\\compilerPackage\\Shakespeare.g:147:62: adjective
							{
							pushFollow(FOLLOW_adjective_in_stageEvent837);
							adjective();
							state._fsp--;
	...
	public final void comparison() throws RecognitionException {
		...
		try {
			...
			{
			ch1=(Token)match(input,CHARACTER,FOLLOW_CHARACTER_in_comparison911); 
			match(input,CL,FOLLOW_CL_in_comparison913); 
			...
			switch (alt25) {
				case 1 :
					// C:\\Users\\kevbosk\\Documents\\Università\\github_repo\\LFC_project\\Workspace_Shakespeare\\src\\compilerPackage\\Shakespeare.g:161:19: WS
					{
					match(input,WS,FOLLOW_WS_in_comparison915); 
					}
					break;

			}

			match(input,AMI,FOLLOW_AMI_in_comparison919); 
			...
			switch (alt26) {
				case 1 :
					...
					{
					ev=(Token)match(input,BETTER,FOLLOW_BETTER_in_comparison926); 
					}
					break;
				case 2 :
					...
					{
					ev=(Token)match(input,AS,FOLLOW_AS_in_comparison931); 
					ev=input.LT(1);
					if ( input.LA(1)==NEGATIVEADJECTIVE||input.LA(1)==NEUTRALADJECTIVE||input.LA(1)==POSITIVEADJECTIVE ) {
						input.consume();
						state.errorRecovery=false;
					...
					ev=(Token)match(input,AS,FOLLOW_AS_in_comparison945); 
					}
				...
				case 3 :
					...
					{
					ev=(Token)match(input,WORSE,FOLLOW_WORSE_in_comparison950); 
					}
					break;

			}

			match(input,THAN,FOLLOW_THAN_in_comparison955); 
			match(input,YOUC,FOLLOW_YOUC_in_comparison957); 
			match(input,QM,FOLLOW_QM_in_comparison959); 
			ch2=(Token)match(input,CHARACTER,FOLLOW_CHARACTER_in_comparison966); 
			match(input,CL,FOLLOW_CL_in_comparison968); 
			...
			switch (alt27) {
				case 1 :
					// C:\\Users\\kevbosk\\Documents\\Università\\github_repo\\LFC_project\\Workspace_Shakespeare\\src\\compilerPackage\\Shakespeare.g:166:19: WS
					{
					match(input,WS,FOLLOW_WS_in_comparison970); 
					}
					break;
			...
			match(input,SCENEC,FOLLOW_SCENEC_in_comparison1004); 
			rn=(Token)match(input,ID,FOLLOW_ID_in_comparison1008); 
			match(input,DOT,FOLLOW_DOT_in_comparison1010); 
			...
			switch (alt28) {
				case 1 :
					// C:\\Users\\kevbosk\\Documents\\Università\\github_repo\\LFC_project\\Workspace_Shakespeare\\src\\compilerPackage\\Shakespeare.g:167:87: WS
					{
					match(input,WS,FOLLOW_WS_in_comparison1012); 
					}
					break;
	...
	public static final BitSet FOLLOW_A_in_stageEvent765 = new BitSet(new long[]{0x0000000A80000000L});
	public static final BitSet FOLLOW_adjectiveSecond_in_stageEvent768 = new BitSet(new long[]{0x0000001F80000000L});
	...
	public static final BitSet FOLLOW_A_in_stageEvent793 = new BitSet(new long[]{0x0000001500000000L});
	public static final BitSet FOLLOW_set_in_stageEvent797 = new BitSet(new long[]{0x0000000000140000L});
	public static final BitSet FOLLOW_set_in_stageEvent819 = new BitSet(new long[]{0x0010000000000000L});
	public static final BitSet FOLLOW_THYSELF_in_stageEvent831 = new BitSet(new long[]{0x0000000000000080L});
	public static final BitSet FOLLOW_AND_in_stageEvent833 = new BitSet(new long[]{0x0000000000000010L});
	public static final BitSet FOLLOW_A_in_stageEvent835 = new BitSet(new long[]{0x0000000A80000000L});
	public static final BitSet FOLLOW_adjective_in_stageEvent837 = new BitSet(new long[]{0x0000001F80000000L});
	public static final BitSet FOLLOW_set_in_stageEvent842 = new BitSet(new long[]{0x0000000000140000L});
	public static final BitSet FOLLOW_set_in_stageEvent861 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_set_in_adjective883 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_CHARACTER_in_comparison911 = new BitSet(new long[]{0x0000000000002000L});
	public static final BitSet FOLLOW_CL_in_comparison913 = new BitSet(new long[]{0x0100000000000040L});
	public static final BitSet FOLLOW_WS_in_comparison915 = new BitSet(new long[]{0x0000000000000040L});
	public static final BitSet FOLLOW_AMI_in_comparison919 = new BitSet(new long[]{0x0080000000000C00L});
	public static final BitSet FOLLOW_BETTER_in_comparison926 = new BitSet(new long[]{0x0004000000000000L});
	public static final BitSet FOLLOW_AS_in_comparison931 = new BitSet(new long[]{0x0000000A80000000L});
	public static final BitSet FOLLOW_set_in_comparison933 = new BitSet(new long[]{0x0000000000000400L});
	public static final BitSet FOLLOW_AS_in_comparison945 = new BitSet(new long[]{0x0004000000000000L});
	public static final BitSet FOLLOW_WORSE_in_comparison950 = new BitSet(new long[]{0x0004000000000000L});
	public static final BitSet FOLLOW_THAN_in_comparison955 = new BitSet(new long[]{0x0400000000000000L});
	public static final BitSet FOLLOW_YOUC_in_comparison957 = new BitSet(new long[]{0x0000020000000000L});
	public static final BitSet FOLLOW_QM_in_comparison959 = new BitSet(new long[]{0x0000000000001000L});
	public static final BitSet FOLLOW_CHARACTER_in_comparison966 = new BitSet(new long[]{0x0000000000002000L});
	public static final BitSet FOLLOW_CL_in_comparison968 = new BitSet(new long[]{0x010000000C000000L});
	public static final BitSet FOLLOW_WS_in_comparison970 = new BitSet(new long[]{0x000000000C000000L});
	public static final BitSet FOLLOW_set_in_comparison976 = new BitSet(new long[]{0x0060000040000000L});
	public static final BitSet FOLLOW_set_in_comparison984 = new BitSet(new long[]{0x0000208000000000L});
	public static final BitSet FOLLOW_set_in_comparison996 = new BitSet(new long[]{0x0001000000000000L});
	public static final BitSet FOLLOW_SCENEC_in_comparison1004 = new BitSet(new long[]{0x0000000002000000L});
	public static final BitSet FOLLOW_ID_in_comparison1008 = new BitSet(new long[]{0x0000000000040000L});
	public static final BitSet FOLLOW_DOT_in_comparison1010 = new BitSet(new long[]{0x0100000000000002L});
	public static final BitSet FOLLOW_WS_in_comparison1012 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_set_in_adjectiveSecond1032 = new BitSet(new long[]{0x0000000000000002L});
}
